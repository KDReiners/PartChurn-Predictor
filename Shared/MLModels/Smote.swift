...
class Smote {
    ...
    func findKNearestNeighbors(_ dataPoint: [String: Double], k: Int, data: MLDataTable) async -> [Int]   {
    ...
    func createSyntheticSamplesAsync() async -> MLDataTable {
        ...
        let neighbors =  await findKNearestNeighbors(minorityFeatureValues, k: 3, data: majorityTable)
